...
// Ready some things
$db = GetDatabase("localhost", "root", "", "loginoop");
...
if (!isset($_SESSION["user"])) {
    ...
    if (!isset($_POST["state"])) {
        ...
        if (($_POST["state"]) == "Login" && !isset($_POST["Username"])) {
            ...
            $str .= "<form method=post><input class=fakelink type=submit name=state value=Register></form>";
            echo $str;
        }
            ...
            if ($user->LogIn($db, $_POST["Username"], $_POST["Password"])) {
                ...
                echo("<p>Failed to log in!</p> <br> <form method=post><input class=fakelink type=submit name=state value=Login></form>");
            }
        }
    ...
    $str .= "<form method=post><input class=fakelink type=submit name=state value=Logout></form>";
    echo $str;
}
?>
</body>
